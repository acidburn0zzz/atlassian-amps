...
public enum JiraDatabaseType {
    ...
    HSQL("hsql", true, "jdbc:hsqldb", "org.hsqldb.jdbcDriver", JiraDatabaseType::none),

    H2("h2", true, "jdbc:h2", "org.h2.Driver", JiraDatabaseType::none),
    ...
    private static JiraDatabase none(DataSource ignored) {
        return null;
    }
}
