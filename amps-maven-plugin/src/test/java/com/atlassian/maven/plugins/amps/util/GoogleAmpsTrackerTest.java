...
public class GoogleAmpsTrackerTest
{
    ...
    public void firstTrackCreatesNewVisitor() throws Exception
    {
        ...
        GoogleAmpsTracker tracker = new GoogleAmpsTracker("googleTrackingTester","any","any",logger);
    ...
    public void secondTrackCreatesNewSession() throws Exception
    {
        ...
        Log logger = mock(Log.class);
        GoogleAmpsTracker firstTracker = new GoogleAmpsTracker("googleTrackingTester","any","any",logger);
        ...
        GoogleAmpsTracker secondTracker = new GoogleAmpsTracker("googleTrackingTester","any","any",logger);
