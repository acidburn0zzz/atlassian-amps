...
assert packageDir.list().length == 3, "Package should contain two subpackages" // api and impl
...
assert new File(packageDir, 'config/MyPluginJavaConfig.java').exists(), "impl should contain MyPluginJavaConfig class"
