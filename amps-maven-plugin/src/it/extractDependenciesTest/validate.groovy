...
assert buildLog[2] == '[WARNING] -- META-INF/LICENSE.txt from [commons-text-1.8-jar, commons-lang3-3.9-jar]'
...
assert buildLog[4] == '[WARNING] -- META-INF/NOTICE.txt from [commons-text-1.8-jar, commons-lang3-3.9-jar]'
assert buildLog[5] == '[WARNING] -- org/kxml2/io/KXmlParser.class from [org.apache.felix.bundlerepository-1.4.0-jar, kxml2-2.2.2-jar]'
assert buildLog[6] == '[WARNING] -- org/kxml2/io/KXmlSerializer.class from [org.apache.felix.bundlerepository-1.4.0-jar, kxml2-2.2.2-jar]'
assert buildLog[7] == '[WARNING] -- org/kxml2/kdom/Document.class from [org.apache.felix.bundlerepository-1.4.0-jar, kxml2-2.2.2-jar]'
assert buildLog[8] == '[WARNING] -- org/kxml2/kdom/Element.class from [org.apache.felix.bundlerepository-1.4.0-jar, kxml2-2.2.2-jar]'
assert buildLog[9] == '[WARNING] -- org/kxml2/kdom/Node.class from [org.apache.felix.bundlerepository-1.4.0-jar, kxml2-2.2.2-jar]'
assert buildLog[10] == '[WARNING] -- org/kxml2/wap/Wbxml.class from [org.apache.felix.bundlerepository-1.4.0-jar, kxml2-2.2.2-jar]'
assert buildLog[11] == '[WARNING] -- org/kxml2/wap/WbxmlParser.class from [org.apache.felix.bundlerepository-1.4.0-jar, kxml2-2.2.2-jar]'
assert buildLog[12] == '[WARNING] -- org/kxml2/wap/WbxmlSerializer.class from [org.apache.felix.bundlerepository-1.4.0-jar, kxml2-2.2.2-jar]'
assert buildLog[13] == '[WARNING] -- org/kxml2/wap/syncml/SyncML.class from [org.apache.felix.bundlerepository-1.4.0-jar, kxml2-2.2.2-jar]'
assert buildLog[14] == '[WARNING] -- org/kxml2/wap/wml/Wml.class from [org.apache.felix.bundlerepository-1.4.0-jar, kxml2-2.2.2-jar]'
assert buildLog[15] == '[WARNING] -- org/kxml2/wap/wv/WV.class from [org.apache.felix.bundlerepository-1.4.0-jar, kxml2-2.2.2-jar]'
...
assert buildLog[25] == '[WARNING] -- org/xmlpull/v1/XmlPullParser.class from [org.apache.felix.bundlerepository-1.4.0-jar, xmlpull-1.1.3.1-jar, kxml2-2.2.2-jar]'
assert buildLog[26] == '[WARNING] -- org/xmlpull/v1/XmlPullParserException.class from [org.apache.felix.bundlerepository-1.4.0-jar, xmlpull-1.1.3.1-jar, kxml2-2.2.2-jar]'
assert buildLog[27] == '[WARNING] -- org/xmlpull/v1/XmlPullParserFactory.class from [org.apache.felix.bundlerepository-1.4.0-jar, xmlpull-1.1.3.1-jar, kxml2-2.2.2-jar]'
assert buildLog[28] == '[WARNING] -- org/xmlpull/v1/XmlSerializer.class from [org.apache.felix.bundlerepository-1.4.0-jar, xmlpull-1.1.3.1-jar, kxml2-2.2.2-jar]'
