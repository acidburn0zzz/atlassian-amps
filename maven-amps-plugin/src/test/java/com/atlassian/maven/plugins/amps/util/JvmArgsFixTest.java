...
public class JvmArgsFixTest
{
    ...
    {
        Assert.assertEquals("-XmxSOMETHING -XX:Something=SOMETHING", testDefaults.apply("-XmxSOMETHING -XX:Something=SOMETHING"));
    }
    ...
    {
         Assert.assertEquals("-XmxSOMETHING -XX:Something=STH", JvmArgsFix.defaults().with("-XX:Something=", "STH").apply("-XmxSOMETHING"));
    }
}
