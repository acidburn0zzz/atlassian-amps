...
public class TestProductContainerVersionMapper
{
    ...
    public void testJiraVersionMapping()
    {
        ...
        assertThat(ProductContainerVersionMapper.containerForProductVersion("jira", "7.3.0"), is("tomcat85x"));
        assertThat(ProductContainerVersionMapper.containerForProductVersion("jira", "7.6.0"), is("tomcat85x"));
    }
