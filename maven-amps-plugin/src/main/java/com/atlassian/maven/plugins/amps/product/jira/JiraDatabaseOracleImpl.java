...
public class JiraDatabaseOracleImpl extends AbstractJiraDatabase
{
    ...
    private static final String DROP_AND_CREATE_USER =
            "DECLARE\n"
                    ...
                    + "    EXECUTE IMMEDIATE(q'{CREATE TABLESPACE jiradb2 DATAFILE '/oracle/oradata/XE/jiradb2.dbf' SIZE 32m AUTOEXTEND ON NEXT 32m MAXSIZE 4096m EXTENT MANAGEMENT LOCAL}');\n"
