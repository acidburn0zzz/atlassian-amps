...
import com.atlassian.maven.plugins.amps.util.AmpsCreateMicrosServicePrompterImpl;
 ...
 */
@Mojo(name = "create-micros-service", requiresProject = false)
public class CreateMicrosServiceMojo extends AbstractProductHandlerMojo
{
    @Component (hint = "amps-create-micros-service-prompter")
