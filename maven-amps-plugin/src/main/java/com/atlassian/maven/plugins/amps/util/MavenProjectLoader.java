...
public class MavenProjectLoader
{
     ...
     */
    public Optional<MavenProject> loadMavenProject(MavenSession session, Artifact pomArtifact, boolean includeDependencies)
            throws MojoExecutionException
    {
        try
        {
            ...
            ProjectBuildingRequest projectBuildingRequest = session.getProjectBuildingRequest()
                    ...
                    .setResolveDependencies(includeDependencies);
